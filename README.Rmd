...
<!-- badges: start -->
[![R-CMD-check](https://github.com/KopfLab/chemunits/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/KopfLab/chemunits/actions/workfl
ows/R-CMD-check.yaml)
...
The **chemunits** package expands the functionality of the **[units](https://r-quantities.github.io/units/)** package for routine calculations in chemical/biochemical/geochemical applications by implementing two additional features:
...
NOTE: this package has some strong opinions about what the important default units are for chemical applications and which units should be auto_scaled but this is very easy to change with the `chemunits_options()` if you have different preferences
